...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round(num_bachelors*100/len(df),1)
    ...
    highest_earning_country = (country_rich_count *100 / country_count).idxmax()
    highest_earning_country_percentage = round(country_rich_count *100 / country_count, 1).max()

    # Identify the most popular occupation for those who earn >50K in India.
    indians = df[(df['native-country'] == 'India') & (df['salary'] == ">50K")]
    occ_counts = indians['occupation'].value_counts()
